    ...
    items: [
      {
        ...
        ai: "₹42k–₹48k",
        tag: "Electronics",
        reason: "Because you viewed laptops",
        status: "available",
        image:
      ...
      },
      {
        ...
        ai: "₹17k–₹20k",
        tag: "Audio",
        reason: "Pairs well with electronics",
        status: "available",
        image:
          "https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?w=500&auto=format&fit=crop&q=60",
      },
      {
        id: "3",
    ...
    items: [
      {
        ...
        ai: "₹100–₹150",
        tag: "Notes",
        reason: "Matches 'Computer Science'",
        image: "https://img.sanishtech.com/u/28f66e560a0fa23ef0b1d74d811500a6.jpg",
      },
      {
        id: "5",
    ...
    items: [
      {
        ...
        image: "https://img.sanishtech.com/u/64c83726e8790b30931d183a2bd9dedf.jpg",
      },
      {
        id: "8",
        ...
        ai: "₹400–₹500",
        tag: "Stationery",
        reason: "Common 1st year essential",
        image:
          "https://images.unsplash.com/photo-1583086650426-302a2432c668?w=500&auto=format&fit=crop&q=60",
      },
      {
        id: "9",
        title: "Lab Coat",
        ...
        image:
          "https://images.unsplash.com/photo-1584844308364-a9f44b2046db?w=500&auto=format&fit=crop&q=60",
      },
    ],
  },
  trending: {
    ...
    items: [
      ...
      },
      {
        ...
        ai: "₹500–₹700",
        tag: "Hostel",
        reason: "Hostel essential",
        image:
          "https://images.unsplash.com/photo-1517409249764-a5e27a6c986c?w=500&auto=format&fit=crop&q=60",
      },
    ],
  },
};
...
export function AIRecommendations() {
  ...
  const currentCategory = MOCK_RECOMMENDATIONS[activeTab];

  // Only use live listings
  const displayItems = listings.map((l) => ({
    id: l.id,
    title: l.title,
    price: `₹${(l.price || 0).toLocaleString()}`,
    ai: `₹${((l.price || 0) * 0.9).toFixed(0)}–₹${((l.price || 0) * 1.1).toFixed(0)}`,
    tag: l.category,
    reason: "New on campus",
    image: l.images?.[0],
  }));
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mb-12 text-center md:text-left">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Kampus AI learns what you need. Personalized marketplace suggestions tailored just for
            you.
          </p>
        </div>
        ...
        <div className="mb-8 flex flex-wrap gap-2 overflow-x-auto pb-2 [&::-webkit-scrollbar]:hidden">
          {(Object.keys(MOCK_RECOMMENDATIONS) as Array<keyof typeof MOCK_RECOMMENDATIONS>).map(
            (key) => {
        ...
        <div className="mb-6 flex items-end justify-between">
          ...
          >
            ...
            <div>
              <h3 className="text-lg font-bold">{currentCategory.title}</h3>
          ...
          <div className="hidden items-center gap-2 sm:flex">
            <Button
              ...
              size="icon"
              onClick={() => scroll("left")}
              className="h-9 w-9 shrink-0 rounded-full border-primary/20 bg-background text-primary hover:bg-primary hover:text-primary-foreground"
            >
          ...
          <AnimatePresence>
            {loading
              ? [1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="w-[280px] shrink-0 snap-start rounded-2xl border border-border bg-card p-4 animate-pulse"
                  >
