!(function () {
  ...
  function n() {
    ...
    if (
      ...
      !(e = o.querySelector('.nav-link[href="' + n + '"]')))
    ) {
  ...
  (i
    ? ((c = i.querySelector(".nav")),
      (e = i.querySelector(".nav-menu-toggle")),
      a.addEventListener("click", function (e) {
        if (a.classList.contains("is-active")) return v(e);
        m(e);
      ...
      (o = i.querySelector("[data-panel=menu]")))
    : a && !(a.hidden = !0)) &&
    ((t = i.querySelector("[data-panel=explore]")),
      ...
      if (d) {
        ...
        var l = {},
          u = s.reduce(function (e, t) {
            ...
            return (
              (o.dataset.level = parseInt(t.nodeName.slice(1), 10) - 1),
              o.appendChild(n),
              e.appendChild(o),
              e
            );
      ...
      ? ((a = Array.isArray(a) ? a : Array(a || 0)),
        ...
        s.forEach(function (e, t) {
          ...
          t === i || e.getBoundingClientRect().top + h(e, "paddingTop") > r
            ? (o.push(n), a.indexOf(n) < 0 && l[n].classList.add("is-active"))
            : ~a.indexOf(n) && l[a.shift()].classList.remove("is-active");
        }),
      ...
      : (Array.isArray(a) &&
        ...
        t
          ? t !== a &&
            ...
            (a = t))
          : a && (l[a].classList.remove("is-active"), (a = undefined)));
  }
  function h(e, t) {
...
!(function () {
  ...
  var o,
    i,
    c = document.querySelector("article.doc");
  function n(e) {
  ...
  function r(e) {
    ...
    var t =
      (function n(e, t) {
        return c.contains(e) ? n(e.offsetParent, e.offsetTop + t) : t;
      })(this, 0) - o.getBoundingClientRect().bottom;
    !1 === e && i
      ? window.scrollTo({ left: 0, top: t, behavior: "instant" })
      : window.scrollTo(0, t);
  }
  c &&
    ((o = document.querySelector(".toolbar")),
    (i = "scrollTo" in document.documentElement),
    window.addEventListener("load", function l(e) {
      var t;
      ((t = n(window.location.hash)) &&
        (t = document.getElementById(t)) &&
        (r.call(t, !1), setTimeout(r.bind(t, !1), 250)),
        window.removeEventListener("load", l));
    }),
    Array.prototype.slice.call(document.querySelectorAll('a[href^="#"]')).forEach(function (e) {
      var t;
      (t = n(e.hash)) && (t = document.getElementById(t)) && e.addEventListener("click", r.bind(t));
    }));
})();
!(function () {
  "use strict";
    ...
    .forEach(function (e) {
      ...
      (((i = document.createElement("div")).className = "source-toolbox"),
        ...
        d &&
          ...
          "svg" === r
            ? ((a = document.createElementNS("http://www.w3.org/2000/svg", "svg")).setAttribute(
                "class",
                "copy-icon",
              ),
...
!(function () {
  "use strict";
  function i(e, t, r) {
    if (e.scrollHeight !== e.getBoundingClientRect().height)
      for (
        t = t.slice(1, -1).reverse();
        t.length && e.scrollHeight > e.getBoundingClientRect().height;
      ) {
        var i,
          n = t.pop(),
          l = (n = n.querySelector("a") || n).innerText.trim();
        l.length > r &&
          (n.setAttribute("title", l),
          (i = l.slice(0, (i = r - 3)) + (" " === l.charAt(i) ? " " : "") + "..."),
          (n.innerText = i));
      }
  }
  var e, t, r;
  !(r = document.querySelector(".toolbar")) ||
    (e = Array.prototype.slice.call(r.querySelectorAll(".breadcrumbs li") || [])).length < 3 ||
    (t = parseInt(r.querySelector(".breadcrumbs").dataset.truncationLength || 15, 10)) < 0 ||
    (i(r, e, t),
    window.addEventListener(
      "resize",
      function (e, t, r) {
        (t.forEach(function (e) {
          (e = e.querySelector("a") || e).hasAttribute("title") &&
            ((e.innerText = e.getAttribute("title")), e.removeAttribute("title"));
        }),
          i(e, t, r));
      }.bind(null, r, e, t),
    ));
